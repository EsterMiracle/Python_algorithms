...
# Общая сложность: О(1)
def auth_ver1(users, user_name, user_password):
    if users.get(user_name):
        if users[user_name]['password'] == user_password and users[user_name]['activation']:
            return "Добро пожаловатЬ! Ваша учётная запись активирована!"
        elif users[user_name]['password'] == user_password and not users[user_name]['activation']:
            return "Учетная запись не активна! Пройдите пожалуйста активацию!"
...
# Общая сложность: O(n)
def auth_ver2(users, user_name, user_password):
